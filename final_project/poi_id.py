...
def setup_clf_list():
    ...
    params_linearsvm = {"C": [0.5, 1, 5, 10, 100, 10**10],
                        "tol":[10**-1, 10**-10],
                        "class_weight":['balanced']       #'auto' can also be used but for python 2.7 balanced is used.
...
## Now using GridSearchCV to find the optimal parameters for a classifier.
...
## Train unsupervised classifiers using KMeans for now.
